...
public class MovieResource {
    ...
    public Response addMovie(String title, int budget, int length, int releaseYear, byte[] coverPicture, AgeClassification ageClassification, Genre genre) {
    ...
    @Path("/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response modifyMovie(@PathParam("id") long id, String title, int budget, int length, int releaseYear, byte[] coverPicture, AgeClassification ageClassification, Genre genre) {
        try {
